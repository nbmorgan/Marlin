...
#define STRING_CONFIG_H_AUTHOR "(nbmorgan, from RC8 config)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // TEVO Trantula from PID Autotune with metal extuders
#define  DEFAULT_Kp 17.08
#define  DEFAULT_Ki 1.09
#define  DEFAULT_Kd 66.72
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //TEVO Trantula Metal Heated Bed with coating
  //#define  DEFAULT_bedKp 500
  //#define  DEFAULT_bedKi 1
  //#define  DEFAULT_bedKd 800

  //#define  DEFAULT_bedKp 290.20
  //#define  DEFAULT_bedKi 56.77
  //#define  DEFAULT_bedKd 370.84

  #define  DEFAULT_bedKp 390.20
  #define  DEFAULT_bedKi 66.77
  #define  DEFAULT_bedKd 370.84
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 97.0874, 97.0874 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 225, 225, 3, 25, 25 }
